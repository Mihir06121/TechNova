  ...
  return (
    ...
    // </div>
      <div>
        ...
        <div className='py-lg-5 bg-about'>
              ...
              <div className='row'>
                ...
                <div style={{}}>
                  <div className='d-flex justify-content-center align-items-center'>
                    ...
                    }}>Creative Events</Button>
                  </div>
                  <div className='p-3'>
                    <Collapse isOpen={isOpen2}>
                        <p>I am sample Text to display</p>
                        <div className='border-lg rounded-lg p-3'>
                        <div className="accordion" id="accordionExample1">
                          ...
                          <div className="accordion-item">
                            <h2 className="accordion-header" id="headingSix">
                              <a style={{background:"transparent", cursor: "pointer"}} className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                POETRY SLAM
                              </a>
                            </h2>
